          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="col-span-12 md:col-span-4">
              <div className="testimonial-card relative overflow-hidden group h-full border border-secondary-20">
                <div className="bg-white p-8 h-full transition-transform duration-500 hover:scale-98">
                  {/* Quote Icon */}
                  ...
                  {/* Quote */}
                  <blockquote className="text-secondary/80 mb-6 text-lg leading-relaxed relative z-10">
                    "{testimonial.quote}"
                  </blockquote>
