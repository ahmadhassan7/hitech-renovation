        ...
        <div className="testimonials-grid grid-12 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="col-span-12 md:col-span-4">
              <div className="testimonial-card relative overflow-hidden group h-full border border-secondary-20">
                <div className="bg-white p-6 md:p-8 h-full transition-transform duration-500 hover:scale-98">
                  {/* Quote Icon */}
                  ...
                  <div className="flex gap-1 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="w-4 md:w-5 h-4 md:h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  {/* Quote */}
                  <blockquote className="text-secondary/80 mb-6 text-base md:text-lg leading-relaxed relative z-10">
                    "{testimonial.quote}"
                  </blockquote>
